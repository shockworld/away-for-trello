const translations = {
  en: {
    ...
    cardScope: "Show the notice on cards",
    allCards: "All cards",
    assignedCards: "Only cards where I am assigned",
    language: "Display language",
    automatic: "Automatic",
    save: "Save notice",
    editNotice: "Edit my notice",
    saved: "Notice saved.",
  ...
  es: {
    ...
    cardScope: "Mostrar el aviso en las tarjetas",
    allCards: "Todas las tarjetas",
    assignedCards: "Solo tarjetas donde estoy asignado",
    language: "Idioma del aviso",
    automatic: "Automático",
    save: "Guardar aviso",
    editNotice: "Editar mi aviso",
  ...
  ca: {
    ...
    cardScope: "Mostra l'avís a les targetes",
    allCards: "Totes les targetes",
    assignedCards: "Només targetes on estic assignat",
    language: "Idioma de l'avís",
    automatic: "Automàtic",
    save: "Desa l'avís",
    editNotice: "Edita el meu avís",
    saved: "Avís desat.",
